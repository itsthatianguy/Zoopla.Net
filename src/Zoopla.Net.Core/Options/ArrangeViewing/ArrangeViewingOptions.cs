...
namespace Zoopla.Net.Core.Options.ArrangeViewing
{
    public class ArrangeViewingOptions : OptionsBase
    {
        ...
        {
            set => UrlValues["listing_id"] = value.ToString();
        }

        public string Name
        {
            set => UrlValues["name"] = value;
        }

        public string Email
        {
            set => UrlValues["email"] = value;
        }

        public string Phone
        {
            set => UrlValues["phone"] = value;
        }

        public PhoneType PhoneType
        {
            set => UrlValues["phone_type"] = value.ToString()?.ToLower();
        }

        public BestTimeToCall BestTimeToCall
        {
            set => UrlValues["best_time_to_call"] = value.ToString()?.ToLower();
        }

        public string Message
        {
            set => UrlValues["message"] = value;
        }
    }
}
