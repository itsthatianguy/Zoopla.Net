...
namespace Zoopla.Net.Options
{
    public abstract class ListingBaseOptions : OptionsBase
    {
        ...
        public float Radius
        {
            set
            {
                UrlValues["radius"] = Math.Min(value, 40).ToString();
            } 
        } 
        public OrderBy OrderBy
        {
            set
            {
                UrlValues["order_by"] = value.ToString()?.ToLower();
            }
        }
        ...
        public int MinimumPrice
        {
            set
            {
                UrlValues["minimum_price"] = value.ToString();
            }
        }
        public int MaximumPrice
        {
            set
            {
                UrlValues["maximum_price"] = value.ToString();
            }
        }
        ...
        public int MaximumBeds
        {
            set
            {
                UrlValues["maximum_beds"] = value.ToString();
            }
        }
        ...
        public string Keywords
        {
            set
            {
                UrlValues["keywords"] = Regex.Replace(value, @"[^A-Za-z0-9_\.~]+", "+"); ;
            }
        }
        ...
        public bool Summarized
        {
            set
            {
                UrlValues["summarized"] = value.ToString();
            }
        }
    }
}
